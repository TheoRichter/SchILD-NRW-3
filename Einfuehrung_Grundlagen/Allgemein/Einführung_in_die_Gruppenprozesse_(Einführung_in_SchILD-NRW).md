...
![SchILD_Einführung_Gruppenprozesse_ContainerZuProzess.png](../../graphics/SchILD_Einführung_Gruppenprozesse_ContainerZuProzess.png)
...
![SchILD_Einführung_Gruppenprozesse_Kategorien.png](../../graphics/SchILD_Einführung_Gruppenprozesse_Kategorien.png)
...
![SchILD_Einführung_Gruppenprozesse_IndividualdatenÄndern.png](../../graphics/SchILD_Einführung_Gruppenprozesse_IndividualdatenÄndern.png)
...
![SchILD_Einführung_Gruppenprozesse_Auswahl.png](../../graphics/SchILD_Einführung_Gruppenprozesse_Auswahl.png)
...
![Status_aktiv.jpg](../../graphics/Status_aktiv.jpg)
...
![SchILD_Einführung_Gruppenprozesse_IndividualdatenÄndern_Ausführen.png](../../graphics/SchILD_Einführung_Gruppenprozesse_IndividualdatenÄndern_Ausführen.png)

 Anschließend muss der Gruppenprozess über den Button
*Ausführen* angestoßen werden.  

![Sicherheitsabfrage.jpg](../../graphics/Sicherheitsabfrage.jpg)

 Wird die folgende Sicherheitsabfrage *Daten bei allen
ausgewählten Schülern ändern* bejaht, ist der Gruppenprozess
abgeschlossen.  

![SchILD_Einführung_Gruppenprozesse_Kontrolle.png](../../graphics/SchILD_Einführung_Gruppenprozesse_Kontrolle.png)
...
### Grundlagen zum Thema Gruppenprozesse<div style="text-align:left"><youtube>mYl_uzhFLkA</youtube></div>

### Abändern des Feldes Status<div style="text-align:left"><youtube>9retUdwaZhs</youtube></div>

### Klasse per Gruppenprozess zuweisen<div style="text-align:left"><youtube>BLH3x_G72JU</youtube></div>