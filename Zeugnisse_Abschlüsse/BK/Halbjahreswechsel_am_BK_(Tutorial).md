...
übertragen.Alle übrigen Schüler mit dem **Status** *Aktiv* sind ins neue Halbjahr
...
-   Kontrollieren Sie die Daten **Konferenzdatum**, **Zeugnisdatum** und
    **Entlassdatum**.
-   Prüfen Sie auf die üblichen Korrekturen. Unter *Schüler ➜ Akt.
    Halbjahr ➜ Leistungsdaten* ➜ **Zeugnis/Abschluss** müssen die Daten
    korrekt eingetragen sein. Nutzen Sie gegebenenfalls den
    Schülerfilter, grundsätzlich sollten aber alle Schüler manuell
    geprüft werden.Achten Sie hierbei darauf, dass die Felder *Vers-Vermerk*,
*Abschluss-Art*, *Folgeklasse* (ist bei Abschlüssen und Abgängen leer)
und *Zeugnisart* zusammen passen.
