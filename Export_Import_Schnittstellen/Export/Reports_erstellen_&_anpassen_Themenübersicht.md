# Reports erstellen & anpassen Themenübersicht

WIKILINK: Reportdesigner_-_Schnelleinstieg

## 📝Reports erstellen & anpassen

Diese Seite bietet eine thematische Übersicht zu allen Artikeln, die
beschreiben, wie Reports in SchILD-NRW 3 neu erstellt und vorhandene
Reports abgeändert und erweitert werden können. Sie dient dazu, schnell
den passenden Einstieg in die Erstellung oder Bearbeitung von Berichten
zu finden.

## Der Reportdesigner - Was ist das?

![Reportdesigner.png](../../graphics/Reportdesigner.png)
...
![Reportverwaltung.png](../../graphics/Reportverwaltung.png)
...
Warum das Rad neu erfinden? Passen Sie bestehende Reports an-   

WIKILINK: Einen_neuen_Report_mit_dem_Berichtsassistenten_erstellen´  
Ein Assistent unterstützt Sie bei der Erstellung einfacher Reports