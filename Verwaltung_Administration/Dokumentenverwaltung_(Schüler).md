# Dokumentenverwaltung (Schüler)Wurde die Dokumentenverwaltung über *Verwaltung ➜ Einstellungen ➜
Globale Einstellungen ➜ Dokumentenverwaltung* aktiviert, steht nun ein
weiterer Reiter **Dokumentenverwaltung** bei den Schülern zur Verfügung.Konsultieren Sie hierzu den Artikel 
...
Optionen der Dokumentenablage eingeblendet.-   **Drucker mit Archivierung** sendet den Report zu einem Drucker und
    zusätzlich wird ein PDF im Ordner des Schülers der Dokumentenablage
    erzeugt.
-   **nur Archivierung (in Dokumentenverwaltung)** erzeugt nur das PDF.
