# Gesamtprüfung der Daten (Verwaltung Statistik für IT-NRW)
...
Die Prüfung von SchILD-NRW findet nicht alle Fehler, die in ASDPC
auftauchen können, wo diese Daten dann auch zusätzlich zueinander in
Bezug gesetzt werden. Jedoch lassen sich viele grundsätzliche
Fehleinträge schon in SchILD auflösen.  

## Arbeit mit den gefundenen Fehlern
...
Dieses Protokoll kann über den nachfolgenden Menüpunkt **Fehlerprotokoll
anzeigen** jederzeit wieder aufgerufen werden.Im pdf-Fehlerprotokoll ist die **ID** zu sehen, über welche die Schüler
identifiziert werden. Weiterhin findet sich **Kürzel** und
**Fehlertext**, die einmal technisch und einmal für Menschen lesbar den
zu behebenden Fehler bestimmen.

Die **Fehlerart** gibt die Schwere des Fehlers an. Der Umgang mit den
Fehlerarten wird in der Dokumentation der Statistik von IT.NRW
besprochen.  
...
bestätigt werden, denn die Fehler wurden ja *erledigt*.  
Öffnen Sie später wieder *Auswahl* ➜ **Schüler mit Statistikfehlern
zeigen** kann die Arbeit nahtlos am letzten Stand fortgesetzt werden.Es kann jederzeit über *Verwaltung ➜ Statistik für IT.NRW* ➜
**Gesamtprüfung der Daten** eine neue Prüfung angestoßen werden.
...
noch nicht anliegt. Ein guter Zeitpunkt wäre etwa nach dem Abschluss des
jährlichen Neuaufnahmeprozesses kurz nach Beginn des neuen Schuljahres,
