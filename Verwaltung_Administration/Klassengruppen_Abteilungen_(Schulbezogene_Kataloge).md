...
diese Abteilungsleitungen bzw. Koordinatoren dann über die
Benutzerverwaltung mit passenden Rechten auszustatten.Außerdem können diese Abteilungsleitungen bzw. Koordinatoren über einen
Report aufgerufen werden, um die Verantwortlichen und ihre gesetzten
Kontaktdaten automatisch basierend auf einer im Report verarbeiteten
Klassen im Report einzubinden, zum Beispiel "Auskunft erteilt
Mustermann, Durchwahl -032".Legen Sie zuerst wie in SchILD üblich mit dem "**+**" eine Abteilung an,
die sie nun benennen können. Fügen Sie eine *koordinierende Person*
