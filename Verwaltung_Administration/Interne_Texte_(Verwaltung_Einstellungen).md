...
**Interne Text** die Emailinhalte für den Versand von-   *Notendateien*
-   *Passwörter an Lehrkräfte*
-   *Versand von Reportdateien*festlegen. Der automatisch generierte Inhalt wird dann eingefügt.Gegebenenfalls, zum Beispiel bei Reports, wird der Inhalt als Anhang an
die Mail gehängt.